                ...
                <div className="col-12">
                  <div className="row mt-4">
                    <div className="col-sm-4" style={{ textAlign: "center" }}>
                      {data && (
                        <a
                          href={`${Route.SERVER_URLL}/${data.personal_photo}`}
                          target="_blank"
                        >
                          <img
                            max-width="200px"
                            width="auto"
                            height="100px"
                            src={`${Route.SERVER_URLL}/${data.personal_photo}`}
                            alt="..."
                          />
                        </a>
                      )}
                    ...
                    <div className="col-sm-4" style={{ textAlign: "center" }}>
                      {data && (
                        <a
                          href={`${Route.SERVER_URLL}/${data.license_photo}`}
                          target="_blank"
                        >
                          <img
                            max-width="200px"
                            width="auto"
                            height="100px"
                            src={`${Route.SERVER_URLL}/${data.license_photo}`}
                            alt="..."
                          />
                        </a>
                      )}
                    ...
                    <div className="col-sm-4" style={{ textAlign: "center" }}>
                      {data && (
                        <a
                          href={`${Route.SERVER_URLL}/${data.other_document}`}
                          target="_blank"
                        >
                          <img
                            max-width="200px"
                            width="auto"
                            height="100px"
                            src={`${Route.SERVER_URLL}/${data.other_document}`}
                            alt="..."
                          />
                        </a>
                      )}
