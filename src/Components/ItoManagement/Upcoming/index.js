...
import { getUpcomingItoSeries } from "../../../Redux/actions/actions";
...
const Upcoming = ({
  ...
  useEffect(() => {
    getUpcomingItoSeries(ito ? ito.id : 0);
  }, []);
...
export default connect(mapStateToProps, { getUpcomingItoSeries })(Upcoming);
