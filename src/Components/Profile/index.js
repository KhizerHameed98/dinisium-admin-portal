...
const Profile = ({
  ...
  const [formData, setFormData] = useState({
    currentPassword: profileData?.userDetails?.password || "",
    password: "",
  });
  // const { currentPassword, password } = profileData.userDetails;
  // console.log(
  // "Password Valuesssss============>",
  // profileData.userDetails.password
  // );
  const { currentPassword, password } = formData;
  console.log("Current Password::", profileData);
  const onChange = (e) => {
